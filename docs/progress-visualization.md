...
The player view also shows a compact recent-form panel and a latest-versus-previous season comparison. The comparison reports categorical division movement, table-position movement and team fixture records without inventing a numeric league score.
